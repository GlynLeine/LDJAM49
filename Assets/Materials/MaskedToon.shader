...
CBUFFER_END
	...
	#define _AmbientColor          UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4 , Metadata__AmbientColor)
	#define _SecondaryColor          UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4 , Metadata__SecondaryColor)
	...
	// small arithmetic cost but no extra register pressure from ImmCB_0_0_0 matrix.
		...
		half4 UniversalFragmentBlinnPhong(InputData inputData, half3 diffuse, half4 specularGloss, half smoothness, half3 emission, half alpha)
		{
			...
			half4 LitPassFragmentSimple(Varyings input) : SV_Target
			{
				...
				half maskValue = SAMPLE_TEXTURE2D_X(_MaskMap, sampler_MaskMap, uv).x;

				half3 diffuse = lerp(_SecondaryColor.rgb, diffuseAlpha.rgb * _BaseColor.rgb, maskValue);

				half alpha = lerp(_SecondaryColor.a, diffuseAlpha.a * _BaseColor.a, maskValue);
